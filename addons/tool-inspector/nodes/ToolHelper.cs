...
[GlobalClass, Tool]
public partial class ToolHelper : Node, IToolHelper {
    ...
    public virtual bool _InspectorProperty(ToolEditorInspector inspector, Variant.Type type, string name, PropertyHint hintType, string hintString, PropertyUsageFlags usageFlags, bool wide){
		return false;
	}
}
